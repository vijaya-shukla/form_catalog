<template>
    <div>
        <div><h2>Question #3</h2></div>
          <div><textarea id="ask" cols="80" rows="5" v-model="questhreedata"></textarea></div>
